...
__conda_setup="$('/home/pyravlos/conda/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/conda/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/conda/miniconda3/etc/profile.d/conda.sh"
    else
